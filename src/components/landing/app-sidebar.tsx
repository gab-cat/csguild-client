...
export function AppSidebar() {
  return (
    <Sidebar variant="inset">
      <SidebarHeader>
        <div className="flex items-center gap-2 px-2 py-4">
          ...
          <div className="flex flex-col">
            <span className="font-jetbrains font-semibold text-sm">CS Guild</span>
            <span className="font-jetbrains text-xs text-pink-400">v2.0.dev</span>
          </div>
        </div>
      </SidebarHeader>
      <SidebarContent>
        {navigationItems.map((section) => (
          <SidebarGroup key={section.title}>
            <SidebarGroupLabel className="font-jetbrains text-xs uppercase tracking-wider text-pink-400">
              {section.title}
            </SidebarGroupLabel>
            <SidebarGroupContent>
              <SidebarMenu>
                {section.items.map((item) => (
                  <SidebarMenuItem key={item.title}>
                    <SidebarMenuButton asChild>
                      <a href={item.url} className="font-poppins text-gray-300 hover:text-pink-400 hover:bg-pink-500/10 transition-colors duration-200">
      ...
      <SidebarFooter>
        <div className="p-2">
          <div className="font-jetbrains text-xs text-pink-400 flex items-center gap-1">
