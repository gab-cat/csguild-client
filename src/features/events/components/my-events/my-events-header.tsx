    ...
    >
      ...
      <div className="space-y-4">
        ...
        <p className="text-lg tracking-tight text-gray-300 max-w-3xl mx-auto">
          Manage your attended and created events. Track your participation and 
          organize amazing experiences for the community.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto mt-12">
        ...
        >
          ...
          <p className="text-sm text-gray-400 text-center">
            View all the events you&apos;ve participated in and track your learning journey
          </p>
        </motion.div>
        ...
        >
          ...
          <h3 className="text-lg font-semibold text-white">Created Events</h3>
          <p className="text-sm text-gray-400 text-center">
            Manage your organized events and see how your community engages
          </p>
        </motion.div>
      </div>
    </motion.div>
