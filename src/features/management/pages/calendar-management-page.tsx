  ...
  return (
    ...
    >
      ...
      <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
        <DialogContent className="max-w-5xl max-h-[95vh] overflow-y-auto bg-gray-900/95 backdrop-blur-xl border border-gray-500/30 shadow-2xl">
          <motion.div
      ...
      <AlertDialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <AlertDialogContent className="bg-gray-900/95 backdrop-blur-xl border border-gray-500/30 shadow-2xl">
          <motion.div
            initial={{ opacity: 0, scale: 0.95, y: 20 }}
            animate={{ opacity: 1, scale: 1, y: 0 }}
            exit={{ opacity: 0, scale: 0.95, y: 20 }}
          ...
          >
            ...
            <AlertDialogFooter className="gap-3">
              ...
              <AlertDialogAction
                ...
                className="bg-red-600 hover:bg-red-700 shadow-lg hover:shadow-red-500/25 transition-all duration-300"
              >
                    Delete
              </AlertDialogAction>
            </AlertDialogFooter>
