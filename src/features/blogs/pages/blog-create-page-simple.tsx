...
import { Save, Send, ArrowLeft, Upload, X, Plus, Hash, Edit3, Settings } from 'lucide-react'
...
Welcome to my blog post! This is where you can share your thoughts and expertise.

## Getting Started

You can use **bold text**, *italic text*, and `inline code` to make your content more engaging.
