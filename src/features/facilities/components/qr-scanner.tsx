...
interface FacilityQrScannerProps {
  onScan: (rfidId: string) => void | Promise<void>
  isScanning: boolean
...
export function FacilityQrScanner({
  onScan,
  isScanning,
  lastScannedRfid,
  disabled = false,
  errorMessage = null
}: FacilityQrScannerProps) {
  ...
  const handleScan = useCallback(
    async (results: Array<{ rawValue?: string }> | undefined) => {
