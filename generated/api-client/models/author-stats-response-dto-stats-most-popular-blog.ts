 ...
 * 
 * @export
 * @interface AuthorStatsResponseDtoStatsMostPopularBlog
 */
export interface AuthorStatsResponseDtoStatsMostPopularBlog {
    /**
     * 
     * @type {string}
     * @memberof AuthorStatsResponseDtoStatsMostPopularBlog
     */
    'slug'?: string;
    /**
     * 
