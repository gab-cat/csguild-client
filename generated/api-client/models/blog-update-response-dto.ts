...
// @ts-ignore
import { BlogDetailResponseDto } from './blog-detail-response-dto';

/**
 * 
 * @export
 * @interface BlogUpdateResponseDto
 */
export interface BlogUpdateResponseDto {
    /**
     * 
     * @type {string}
     * @memberof BlogUpdateResponseDto
     */
    'message': string;
    /**
     * 
