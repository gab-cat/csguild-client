 ...
 * 
 * @export
 * @interface FeedbackResponseAttendeeDto
 */
export interface FeedbackResponseAttendeeDto {
    /**
     * Total attendance duration in minutes
     * @type {number}
     * @memberof FeedbackResponseAttendeeDto
     */
    'totalDuration': number;
    /**
     * Whether the attendee is eligible for certification
     * @type {boolean}
     * @memberof FeedbackResponseAttendeeDto
     */
    'isEligible': boolean;
