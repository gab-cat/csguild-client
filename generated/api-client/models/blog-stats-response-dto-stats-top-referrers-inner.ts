 ...
 * 
 * @export
 * @interface BlogStatsResponseDtoStatsTopReferrersInner
 */
export interface BlogStatsResponseDtoStatsTopReferrersInner {
    /**
     * 
     * @type {string}
     * @memberof BlogStatsResponseDtoStatsTopReferrersInner
     */
    'source'?: string;
    /**
     * 
