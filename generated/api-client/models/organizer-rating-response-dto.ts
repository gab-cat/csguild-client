...
// @ts-ignore
import { OrganizerRatingResponseDtoRating } from './organizer-rating-response-dto-rating';

/**
 * 
 * @export
 * @interface OrganizerRatingResponseDto
 */
export interface OrganizerRatingResponseDto {
    /**
     * Response message
     * @type {string}
     * @memberof OrganizerRatingResponseDto
     */
    'message': string;
    /**
     * HTTP status code
    ...
    /**
     * 
     * @type {OrganizerRatingResponseDtoRating}
     * @memberof OrganizerRatingResponseDto
     */
    'rating': OrganizerRatingResponseDtoRating;
}
