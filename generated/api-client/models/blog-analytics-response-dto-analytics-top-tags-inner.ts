 ...
 * 
 * @export
 * @interface BlogAnalyticsResponseDtoAnalyticsTopTagsInner
 */
export interface BlogAnalyticsResponseDtoAnalyticsTopTagsInner {
    /**
     * 
     * @type {string}
     * @memberof BlogAnalyticsResponseDtoAnalyticsTopTagsInner
     */
    'name'?: string;
    /**
     * 
