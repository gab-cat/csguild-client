...
// @ts-ignore
import { BlogAnalyticsResponseDtoAnalytics } from './blog-analytics-response-dto-analytics';

/**
 * 
 * @export
 * @interface BlogAnalyticsResponseDto
 */
export interface BlogAnalyticsResponseDto {
    /**
     * 
     * @type {string}
     * @memberof BlogAnalyticsResponseDto
     */
    'message': string;
    /**
     * 
    ...
    /**
     * 
     * @type {BlogAnalyticsResponseDtoAnalytics}
     * @memberof BlogAnalyticsResponseDto
     */
    'analytics': BlogAnalyticsResponseDtoAnalytics;
}
