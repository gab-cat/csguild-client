 ...
 * 
 * @export
 * @interface OrganizerStatisticsResponseDtoStatisticsOrganizer
 */
export interface OrganizerStatisticsResponseDtoStatisticsOrganizer {
    /**
     * 
     * @type {string}
     * @memberof OrganizerStatisticsResponseDtoStatisticsOrganizer
     */
    'username'?: string;
    /**
     * 
