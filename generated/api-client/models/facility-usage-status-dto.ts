 ...
 * 
 * @export
 * @interface FacilityUsageStatusDto
 */
export interface FacilityUsageStatusDto {
    /**
     * RFID card ID to check status
     * @type {string}
     * @memberof FacilityUsageStatusDto
     */
    'rfidId': string;
    /**
     * Facility ID to check status in
     * @type {string}
     * @memberof FacilityUsageStatusDto
     */
    'facilityId': string;
