 ...
 * 
 * @export
 * @interface BlogAnalyticsResponseDtoAnalyticsTopCategoriesInner
 */
export interface BlogAnalyticsResponseDtoAnalyticsTopCategoriesInner {
    /**
     * 
     * @type {string}
     * @memberof BlogAnalyticsResponseDtoAnalyticsTopCategoriesInner
     */
    'name'?: string;
    /**
     * 
